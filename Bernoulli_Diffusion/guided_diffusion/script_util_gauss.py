...
from .respace_gauss import SpacedDiffusion, space_timesteps
...
def create_model(
    ...
    return UNetModel(
       # image_size=image_size,
        in_channels=8, #number_in_channels, change to 8 for BRATS; or 2 for OCT
        model_channels=num_channels,
        out_channels=4,#2*number_in_channels,#12,#(3 if not learn_sigma else 6),now we need 4 for BRATS, 1 for OCT

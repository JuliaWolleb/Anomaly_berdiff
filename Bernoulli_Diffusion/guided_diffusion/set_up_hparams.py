...
def add_training_args(parser):
  ...
  #  parser.add_argument("--guidance", const=True, action="store_const", default=True)
...
def get_sampler_H_from_parser(parser):
    ...
    parser_args.guidance = True   #CAUTION!!! Hardcoded here, TODO: adapt it to be an argument again!
    parser_args.num_classes=2
    H = apply_parser_values_to_H(H, parser_args)

...
def main():
    ...
    H.n_channels=4
    H.sampler = 'bld'
    H.data_dir = "./data/brats/train_healthy"
    H.dataset='chexpert'
    H.nf=32
    H.img_size=256
...
def create_argparser():
    defaults = dict(
       # clip_denoised=True,
        ...
        use_ddim=True,
        model_path="./results/latentbrats_64healthy290000.pt",
        use_fp16=False,
        img_channels=4,
        weight_decay=0.0,
        lr_anneal_steps=0,
        ...
        dataset='brats',
        ae_load_dir='../BinaryLatentDiffusion/logs/binaryae_brats_custom128_64ch',
        ae_load_step=260000,
        sampler="bld",
        codebook_size=32,
        nf=32,

...
class HparamsBinaryAE(HparamsBase):
    def __init__(self, dataset):
        ...
        if self.dataset == 'churches' or self.dataset == "bedrooms" or self.dataset == "brats" or self.dataset == "OCT":
            print('we got dataset', self.dataset)
            self.attn_resolutions = [16]
            self.data_dir=='./data/brats/training'
            self.batch_size = 3

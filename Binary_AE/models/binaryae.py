...
class Encoder(nn.Module):
    def __init__(self, in_channels, nf, out_channels, ch_mult, num_res_blocks, resolution, attn_resolutions):
        ...
        print('self num sress', self.num_resolutions)
...
class BinaryGAN(nn.Module):
    ...
    def train_iter(self, x, step):
        ...
        p_loss = 0# self.perceptual(x.contiguous(), x_hat.contiguous()) Perceptual loss for 4 channels undefined
        ...
        stats["perceptual"] = 0#p_loss.mean().item()
